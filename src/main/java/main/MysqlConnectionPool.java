...
public class MysqlConnectionPool {
    ...
    public DataSource setupPool(ConfigManager configs) throws Exception {
    ...
    public int getMaxActive() {
        return gPool.getMaxActive();
    }

    public int getNumActive() {
        return gPool.getNumActive();
    }

    public int getNumIdle() {
        return gPool.getNumIdle();
    }
 
    // This Method Is Used To Print The Connection Pool Status
    private void printDbStatus() {
        System.out.println("Max.: " + getMaxActive() + "; Active: " + getNumActive() + "; Idle: " + getNumIdle());
    }
