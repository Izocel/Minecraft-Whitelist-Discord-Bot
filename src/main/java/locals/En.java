...
public class En extends DTraductionMaps {
	...
	protected void initMaps() {
		...
		this.DEFAULTS.put("INFO_LEGITIMATE",
				"If this request seems illegitimate to you, contact an administrator!!!");
		...
		this.DEFAULTS.put("INFO_CONTACT_ADMIN_MORE_INFO",
				"To get more information, contact an admin directly...");
		...
		this.DEFAULTS.put("INFO_ACCESS_REQUESTED",
				"**Your `%s` access request for `%s` was sent to moderators.**");
		...
		this.DEFAULTS.put("INFO_REGISTER_REQUEST",
				"A `%s` player want to register on your `Minecraft®` server");
		...
		this.DEFAULTS.put("REGISTER_CMD_PARAM_ERROR",
				"You must provide at least one pseudo for this command...");
		...
		this.DEFAULTS.put("REGISTER_CMD_NOT_FOUND_UUID",
				"❌ **Your `%s` UUID could not be found on the servers...**");
