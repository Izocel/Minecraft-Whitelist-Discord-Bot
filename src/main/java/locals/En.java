...
public class En extends DTraductionMaps {
    ...
    public En() {
        ...
        this.DEFAULTS.put("CMD_REFERRAL", "referral");
        this.DEFAULTS.put("PARAM_PJAVA", "java-pseudo");
        this.DEFAULTS.put("PARAM_PBEDR", "bedrock-pseudo");
        this.DEFAULTS.put("PARAM_REGISTER_DESCJ", "Your Java pseudo");
        this.DEFAULTS.put("PARAM_REGISTER_DESCB", "Your Bedrock pseudo");
        this.DEFAULTS.put("PARAM_LOOKUP_DESC", "The uuid or pseudo to search for");
        this.DEFAULTS.put("PARAM_LOCAL_SETLOCAL", "language");
        this.DEFAULTS.put("PARAM_LOCAL_DESC", "Available language: ['FR, EN, ES']");
        this.DEFAULTS.put("PARAM_MEMBER", "member");
        this.DEFAULTS.put("PARAM_MEMBER_DESC", "A guild member");
        this.DEFAULTS.put("PARAM_UUID", "uuid");
        this.DEFAULTS.put("PARAM_UUID_DESC", "A Minecraft uuid");
        this.DEFAULTS.put("PARAM_REF_CODE", "Code");
        this.DEFAULTS.put("PARAM_REF_CODE_DESC", "A unique referral code");
        this.DEFAULTS.put("DESC_SERVER", "Show the `Minecraft®` server information.");
        this.DEFAULTS.put("DESC_REGISTER", "Register on the `Minecraft®` server.");
        ...
        this.DEFAULTS.put("DESC_REFERRAL", "Inform's who has invited you to the server.");
