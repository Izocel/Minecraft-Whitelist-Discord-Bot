...
public class Fr extends DTraductionMaps {

        public Fr() {
                super();
                this.DEFAULTS.put("WORD_YES", "Oui");
                this.DEFAULTS.put("WORD_NO", "Non");
                ...
                this.DEFAULTS.put("INFO_LEGITIMATE",
                                "Si cette demande vous semble illégitime, contactez un administrateur!!!");
                this.DEFAULTS.put("INFO_TRY_REGISTER_AGAIN",
                                "Essayez de refaire une demande d'enregistrment sur Discord®.");
                ...
                this.DEFAULTS.put("INFO_MUST_CONFIRM_ACCOUNT",
                                "**Une confirmation de votre compte `%s` est nécéssaire.**\n");
                ...
                this.DEFAULTS.put("INFO_REGISTER_REQUEST",
                                "Un joueur `%s` veut s'enregister sur votre serveur `Minecraft®`");
                ...
                this.DEFAULTS.put("INFO_WELCOME_USER",
                                "**Nous te souhaitons bienvenue, <@%s> :: `%s`.Enjoy  ⛏🧱 !!!**");
                ...
                this.DEFAULTS.put("INFO_USER_WAS_ACCEPTED",
                                "✔️ **Le joueur <@%s> a bien été approuvé pour le pseudo: `%s`.**");
                this.DEFAULTS.put("INFO_USER_WAS_REJECTED",
                                "❌ **Le joueur <@%s> a bien été refusé pour le pseudo: `%s`.**");
                ...
                this.DEFAULTS.put("WARN_ALREADY_REGISTERED",
                                "⚠️ **Ce pseudo `%s` est déjà enregistrer par un autre joueur**");
                this.DEFAULTS.put("WARN_NOT_ACCEPTED_YET",
                                "⚠️ **Ce compte `%s` n'a pas encore été accepté sur le serveur.**");
                ...
                this.DEFAULTS.put("REGISTER_CMD_FORMAT_ERROR",
                                "❌ Vos `identifiants` comportaient des `erreurs` de format.");
                ...
                this.DEFAULTS.put("CMD_REFERRAL", "reference");
                this.DEFAULTS.put("PARAM_PJAVA", "pseudo-java");
                this.DEFAULTS.put("PARAM_PBEDR", "pseudo-bedrock");
                this.DEFAULTS.put("PARAM_REGISTER_DESCJ", "Votre pseudo Java");
                this.DEFAULTS.put("PARAM_REGISTER_DESCB", "Votre pseudo Bedrock");
                this.DEFAULTS.put("PARAM_LOOKUP_DESC", "Le uuid ou le pseudo de recherche");
                ...
                this.DEFAULTS.put("PARAM_MEMBER_DESC", "Un membre de la guild");
                this.DEFAULTS.put("PARAM_UUID", "uuid");
                this.DEFAULTS.put("PARAM_UUID_DESC", "Un uuid minecraft");
                this.DEFAULTS.put("PARAM_REF_CODE", "Code");
                this.DEFAULTS.put("PARAM_REF_CODE_DESC", "Un code de parrainage unique");
                this.DEFAULTS.put("DESC_SERVER", "Afficher les informations du serveur `Minecraft®`.");
                this.DEFAULTS.put("DESC_REGISTER", "S'enregister sur le serveur `Minecraft®`.");
                ...
                this.DEFAULTS.put("DESC_REFERRAL", "Renseignez qui vous a invité sur le serveur.");
                this.DEFAULTS.put("TEXTONLY_CMD",
                                "❌ Cette commande est disponible seulement dans les cannaux textuels.");
                ...
                this.DEFAULTS.put("USER_ONLY_CMD",
                                "❌ Cette commande est réservée aux utilisateurs enregistrés par Discord®.");
